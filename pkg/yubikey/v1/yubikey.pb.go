...
func (x *GetRetriesRequest) Reset() {
	*x = GetRetriesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yubikey_v1_yubikey_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetRetriesRequest) Descriptor() ([]byte, []int) {
	return file_yubikey_v1_yubikey_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetRetriesResponse) Reset() {
	*x = GetRetriesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yubikey_v1_yubikey_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetRetriesResponse) Descriptor() ([]byte, []int) {
	return file_yubikey_v1_yubikey_proto_rawDescGZIP(), []int{6}
}
...
func (x *GetAttestationCertificateRequest) Reset() {
	*x = GetAttestationCertificateRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yubikey_v1_yubikey_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetAttestationCertificateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAttestationCertificateRequest) ProtoMessage() {}

func (x *GetAttestationCertificateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_yubikey_v1_yubikey_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*GetAttestationCertificateRequest) Descriptor() ([]byte, []int) {
	return file_yubikey_v1_yubikey_proto_rawDescGZIP(), []int{7}
}

func (x *GetAttestationCertificateRequest) GetSerial() uint32 {
	if x != nil {
		return x.Serial
	}
	return 0
...
func (x *GetAttestationCertificateResponse) Reset() {
	*x = GetAttestationCertificateResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yubikey_v1_yubikey_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetAttestationCertificateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAttestationCertificateResponse) ProtoMessage() {}

func (x *GetAttestationCertificateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_yubikey_v1_yubikey_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*GetAttestationCertificateResponse) Descriptor() ([]byte, []int) {
	return file_yubikey_v1_yubikey_proto_rawDescGZIP(), []int{8}
}
...
var file_yubikey_v1_yubikey_proto_rawDesc = []byte{
	...
	0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x2b, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x52,
	0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a,
	0x06, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x73,
	0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x2e, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x52, 0x65, 0x74, 0x72,
	...
	0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x3a, 0x0a, 0x20, 0x47, 0x65, 0x74, 0x41, 0x74, 0x74, 0x65,
	...
	0x69, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x73, 0x65, 0x72, 0x69, 0x61,
	0x6c, 0x22, 0x45, 0x0a, 0x21, 0x47, 0x65, 0x74, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74,
	...
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x32, 0x91, 0x04, 0x0a, 0x0e, 0x59, 0x75, 0x62,
	...
	,
...
var file_yubikey_v1_yubikey_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_yubikey_v1_yubikey_proto_goTypes = []interface{}{
	...
	(*GetRetriesRequest)(nil),                 // 5: yubikey.v1.GetRetriesRequest
	(*GetRetriesResponse)(nil),                // 6: yubikey.v1.GetRetriesResponse
	(*GetAttestationCertificateRequest)(nil),  // 7: yubikey.v1.GetAttestationCertificateRequest
	(*GetAttestationCertificateResponse)(nil), // 8: yubikey.v1.GetAttestationCertificateResponse
}
var file_yubikey_v1_yubikey_proto_depIdxs = []int32{
	...
	5, // 3: yubikey.v1.YubikeyService.GetRetries:input_type -> yubikey.v1.GetRetriesRequest
	7, // 4: yubikey.v1.YubikeyService.GetAttestationCertificate:input_type -> yubikey.v1.GetAttestationCertificateRequest
	2, // 5: yubikey.v1.YubikeyService.GetSerials:output_type -> yubikey.v1.GetSerialsResponse
	4, // 6: yubikey.v1.YubikeyService.GetVersion:output_type -> yubikey.v1.GetVersionResponse
	6, // 7: yubikey.v1.YubikeyService.GetRetries:output_type -> yubikey.v1.GetRetriesResponse
	8, // 8: yubikey.v1.YubikeyService.GetAttestationCertificate:output_type -> yubikey.v1.GetAttestationCertificateResponse
...
func file_yubikey_v1_yubikey_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_yubikey_v1_yubikey_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRetriesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yubikey_v1_yubikey_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRetriesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yubikey_v1_yubikey_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAttestationCertificateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yubikey_v1_yubikey_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAttestationCertificateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
